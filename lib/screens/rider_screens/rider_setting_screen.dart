...
import 'package:fyp/screens/faq_screen.dart';
...
class RiderSettingScreen extends StatefulWidget {
  const RiderSettingScreen({Key? key}) : super(key: key);

  @override
  State<RiderSettingScreen> createState() => _RiderSettingScreenState();
}

class _RiderSettingScreenState extends State<RiderSettingScreen> {
  ...
  GestureDetector buildFAQ(BuildContext context, String title) {
    return GestureDetector(
      onTap: () {
  ...
  GestureDetector buildUserManual(BuildContext context, String title) {
    return GestureDetector(
      onTap: () {},
      child: Padding(
        padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 20),
  ...
  GestureDetector buildVendor(BuildContext context, String title) {
    return GestureDetector(
      onTap: () {},
      child: Padding(
        padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 20),
  ...
  GestureDetector buildMechanic(BuildContext context, String title) {
    return GestureDetector(
      onTap: () {
        Navigator.pushNamed(context, '/becomeMechanic');
      },
      child: Padding(
        padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 20),
        child: Row(
  ...
  GestureDetector buildDeliveryBoy(BuildContext context, String title) {
    return GestureDetector(
      onTap: () {},
      child: Padding(
        padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 20),
