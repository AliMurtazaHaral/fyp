...
class RiderInboxScreen extends StatefulWidget {
  const RiderInboxScreen({Key? key}) : super(key: key);

  @override
  State<RiderInboxScreen> createState() => _RiderInboxScreenState();
}

class _RiderInboxScreenState extends State<RiderInboxScreen> {
