...
class _RiderRegistrationScreenState extends State<RiderRegistrationScreen> with TickerProviderStateMixin {
  ...
  final bikeNumberEditingController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    //Bike Number Field
    final bikeNumberField = TextFormField(
      autofocus: false,
      controller: bikeNumberEditingController,
      keyboardType: TextInputType.text,
      validator: (value) {
        if (value!.isEmpty) {
      ...
      onSaved: (value) {
        bikeNumberEditingController.text = value!;
      },
      textInputAction: TextInputAction.next,
      decoration: const InputDecoration(
        fillColor: Colors.white,
