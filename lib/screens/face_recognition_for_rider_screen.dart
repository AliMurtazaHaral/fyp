...
class RiderFaceDetectionScreen extends StatefulWidget {
  String? email;
  String? password;
  String? fullName;
  String? profession;
  ...
  RiderFaceDetectionScreen({super.key, required this.fullName,required this.cnic, required this.email, required this.password, required this.profession, required this.profileImageReference});

  @override
  RiderFaceDetectionScreenState createState() => new RiderFaceDetectionScreenState();
}

class RiderFaceDetectionScreenState extends State<RiderFaceDetectionScreen> {
  bool flag = true;
  File? selectedImage;
  File? second_Image;
  String? message = "";
