...
class MechanicFaceDetectionScreen extends StatefulWidget {
  String? email;
  String? password;
  String? fullName;
  String? profession;
  ...
  MechanicFaceDetectionScreen({super.key, required this.fullName,required this.cnic, required this.email, required this.password, required this.profession, required this.profileImageReference});

  @override
  MechanicFaceDetectionScreenState createState() => new MechanicFaceDetectionScreenState();
}

class MechanicFaceDetectionScreenState extends State<MechanicFaceDetectionScreen> {
  bool flag = true;
  File? selectedImage;
  File? second_Image;
  String? message = "";
  ...
  uploadImage() async {
    ...
    final request = http.MultipartRequest(
        "POST", Uri.parse("https://a242-182-188-198-221.in.ngrok.io/secondImage"));
