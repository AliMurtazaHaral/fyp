...
class MechanicSettingScreen extends StatefulWidget {
  const MechanicSettingScreen({Key? key}) : super(key: key);

  @override
  State<MechanicSettingScreen> createState() => _MechanicSettingScreenState();
}

class _MechanicSettingScreenState extends State<MechanicSettingScreen> {
  ...
  GestureDetector buildPayment(BuildContext context, String title) {
    return GestureDetector(
      onTap: () {},
      child: Padding(
        padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 20),
